...
<body>
	...
	<!-- Faceback left part -->
		...
		<!--Left part-->
		<!--Mobile Image--> 	
	<div style="position:absolute; left:5%; top:35%; padding-top:10px;"> <img src="fb_files/fb_index_file/fb_image_file/mycircle_map.png" width="700" height="275" style="opacity:.7;"> </div>
    <div style="position:absolute; left:7%; top:24%; color:white; font-size:28px;"> <font face="myFbFont">MY Circle helps you connect and share your idea </font> </div>
    <div style="position:absolute; left:7%; top:30%; color:white; font-size:28px;"> <font face="myFbFont"> with pepple around the world. </font></div>
	
	
	
	<!-- Registration -->
	<form  method="post" onSubmit="return check();" name="Reg">
		<div style="position:absolute;left:58%; top:14.5%; color:#000066; font-size:25"> <marquee><h5> Sign Up Today plz!</h5></marquee> </div>
		...
		<div style="position:absolute;left:59.2%; top:48%; font-size:16px; color:white">  Your Email:  </div>
