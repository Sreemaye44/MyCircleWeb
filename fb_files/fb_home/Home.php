...
?>
	...
	<!--Status-->
	<div style=" background:#aad9e2; position:absolute; left:21%; top:8%; height:22%; width:41.4%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);"> </div>
	<div style="position:absolute; left:21%; top:8%;"> <img src="img/Status.PNG"><input type="button" onClick="upload_close();"  value="Update Status" style="background:#5ec2d6; border:#aad9e2;"> <img src="img/photo&video.PNG"><input type="button"  value="Add Photos" onClick="upload_open();" name="file" style="background:#5ec2d6; border:#aad9e2;"></div>
<div style=" background:#F2F2F2; position:absolute; left:21%; top:26.5%; height:6.5%; width:41.4%; z-index:-1;"> </div>
	...
	<div style="position:absolute; left:21.3%; top:11.5%;">
		<textarea style="height:100; width:550;" name="post_txt" maxlength="511" placeholder="What do you want to know?"></textarea>
...
?>
	<?php
		...
		<tr>
			...
			{
			?>
			<td colspan="4"align="left" style="border-top:outset; border-top-width:thin;"> 
			<form method="post">  
				<input type="hidden" name="post_id" value="<?php echo $postid; ?>" >
				<input type="submit" name="delete_post" value=" " style="background-color:#FFFFFF border:#FFFFFF; background-image:url(img/exit.png); width:2.3%;"> 
			</form></a> </td>
			<td>  </td>
			<td> </td>
		</tr>
